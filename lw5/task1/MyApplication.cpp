...
CMyApplication::CMyApplication(const char* title, int width, int height)
	...
	, m_house(
		L"assets/whiteStoneWallTexture.jpg",
		L"assets/roof.png",
		L"assets/garage.png",
		L"assets/whiteWallWithWindow.jpg",
		L"assets/wallWithDoor.jpg",
		L"assets/grass.jpg"
	)
	...
	, m_animate(true)
{
	...
	m_house.SetRotationSpeed(30);
	m_house.SetInclinationAngle(23.5);
}
...
void CMyApplication::OnIdle()
{
	...
	m_house.Animate(static_cast<float>(m_animationController.GetTimeDelta() * 0.001));
	PostRedisplay();
	Sleep(10);
}
...
void CMyApplication::OnKeyboard(unsigned char key, int /*x*/, int /*y*/)
{
	...
	if (key == 'r')
	{
		...
		m_house.SetAnimation(m_animate);
	}
}