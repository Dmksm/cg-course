...
const TCHAR WINDOW_TITLE[] = L"Spherical texture coordinate generation"; // The title bar text
...
bool OnCreate(HWND hWnd)
{
	...
	{
		if ((g_texture = textureLoader.LoadTexture2D(L"floor.bmp")))
		{
			return true;
		}
	}
